...
[Introduction](#introduction)[Note for OpenAI-API compatible endpoints](#note-for-open-ai-api-compatible-endpoints)[Defining a chat function](#defining-a-chat-function)[Streaming chatbots](#streaming-chatbots)[Customizing the Chat UI](#customizing-the-chat-ui)[Multimodal Chat Interface](#multimodal-chat-interface)[Additional Inputs](#additional-inputs)[Additional Outputs](#additional-outputs)[Returning Complex Responses](#returning-complex-responses)[Modifying the Chatbot Value Directly](#modifying-the-chatbot-value-directly)[Using Your Chatbot via API](#using-your-chatbot-via-api)[Chat History](#chat-history)[Collecting User Feedback](#collecting-user-feedback)[What's Next?](#whats-next)

[Chatinterface Examples](../guides/chatinterface-examples/)[Agents And Tool Usage](../guides/agents-and-tool-usage/)[Creating A Custom Chatbot With Blocks](../guides/creating-a-custom-chatbot-with-blocks/)[Chatbot Specific Events](../guides/chatbot-specific-events/)[Creating A Discord Bot From A Gradio App](../guides/creating-a-discord-bot-from-a-gradio-app/)[Creating A Slack Bot From A Gradio App](../guides/creating-a-slack-bot-from-a-gradio-app/)[Creating A Website Widget From A Gradio Chatbot](../guides/creating-a-website-widget-from-a-gradio-chatbot/)
...
## Note for OpenAI-API compatible endpoints[![](data:image/svg+xml...)](#note-for-open-ai-api-compatible-endpoints)
...
## Defining a chat function[![](data:image/svg+xml...)](#defining-a-chat-function)
...
## Streaming chatbots[![](data:image/svg+xml...)](#streaming-chatbots)
...
## Customizing the Chat UI[![](data:image/svg+xml...)](#customizing-the-chat-ui)
...
## Multimodal Chat Interface[![](data:image/svg+xml...)](#multimodal-chat-interface)
...
## Additional Inputs[![](data:image/svg+xml...)](#additional-inputs)
...
## Additional Outputs[![](data:image/svg+xml...)](#additional-outputs)
...
## Returning Complex Responses[![](data:image/svg+xml...)](#returning-complex-responses)
...
You can even show nested thoughts, which is useful for agent demos in which one tool may call other tools. To display nested thoughts, include "id" and "parent\_id" keys in the "metadata" dictionary. Read our [dedicated guide on displaying intermediate thoughts and tool usage](/guides/agents-and-tool-usage) for more realistic examples.
...
## Modifying the Chatbot Value Directly[![](data:image/svg+xml...)](#modifying-the-chatbot-value-directly)
...
## Using Your Chatbot via API[![](data:image/svg+xml...)](#using-your-chatbot-via-api)
...
## Chat History[![](data:image/svg+xml...)](#chat-history)
...
## Collecting User Feedback[![](data:image/svg+xml...)](#collecting-user-feedback)
...
## What's Next?[![](data:image/svg+xml...)](#whats-next)
