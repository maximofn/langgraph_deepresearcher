...
[Watch Now →](https://www.youtube.com/watch?v=6C2JRt2Wi5o)

[![Gradio logo](/_app/immutable/assets/gradio.CHB5adID.svg)](/)  [⚡ Quickstart](/guides/quickstart) [✍️ Docs](/docs) [🎢 Playground](/playground) [🖼️ Custom Components](/custom-components/gallery)
...
[Queuing](../guides/queuing/)[Streaming Outputs](../guides/streaming-outputs/)[Streaming Inputs](../guides/streaming-inputs/)[Alerts](../guides/alerts/)[Progress Bars](../guides/progress-bars/)[Batch Functions](../guides/batch-functions/)[Sharing Your App](../guides/sharing-your-app/)

[Sharing Demos](#sharing-demos)[Hosting on HF Spaces](#hosting-on-hf-spaces)[Sharing Deep Links](#sharing-deep-links)[Embedding Hosted Spaces](#embedding-hosted-spaces)[Embedding with Web Components](#embedding-with-web-components)[Embedding with IFrames](#embedding-with-i-frames)[API Page](#api-page)[Accessing the Network Request Directly](#accessing-the-network-request-directly)[Mounting Within Another FastAPI App](#mounting-within-another-fast-api-app)[Authentication](#authentication)[Password-protected app](#password-protected-app)[OAuth (Login via Hugging Face)](#o-auth-login-via-hugging-face)[OAuth (with external providers)](#o-auth-with-external-providers)[MCP Servers](#mcp-servers)[Rate Limits](#rate-limits)[Analytics](#analytics)[Progressive Web App (PWA)](#progressive-web-app-pwa)

[File Access](../guides/file-access/)[Multipage Apps](../guides/multipage-apps/)[Environment Variables](../guides/environment-variables/)[Resource Cleanup](../guides/resource-cleanup/)[Themes](../guides/themes/)[Client Side Functions](../guides/client-side-functions/)[View Api Page](../guides/view-api-page/)[Internationalization](../guides/internationalization/)
...
## Sharing Demos[![](data:image/svg+xml...)](#sharing-demos)
...
## Hosting on HF Spaces[![](data:image/svg+xml...)](#hosting-on-hf-spaces)
...
## Sharing Deep Links[![](data:image/svg+xml...)](#sharing-deep-links)
...
## Embedding Hosted Spaces[![](data:image/svg+xml...)](#embedding-hosted-spaces)
...
### Embedding with Web Components[![](data:image/svg+xml...)](#embedding-with-web-components)
...
You can see examples of how web components look [on the Gradio landing page](https://www.gradio.app).
...
### Embedding with IFrames[![](data:image/svg+xml...)](#embedding-with-i-frames)
...
## API Page[![](data:image/svg+xml...)](#api-page)
...
## Accessing the Network Request Directly[![](data:image/svg+xml...)](#accessing-the-network-request-directly)
...
## Mounting Within Another FastAPI App[![](data:image/svg+xml...)](#mounting-within-another-fast-api-app)
...
## Authentication[![](data:image/svg+xml...)](#authentication)

### Password-protected app[![](data:image/svg+xml...)](#password-protected-app)
...
### OAuth (Login via Hugging Face)[![](data:image/svg+xml...)](#o-auth-login-via-hugging-face)
...
![](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/gradio-guides/oauth_sign_in.png)
...
### OAuth (with external providers)[![](data:image/svg+xml...)](#o-auth-with-external-providers)
...
## MCP Servers[![](data:image/svg+xml...)](#mcp-servers)
...
## Rate Limits[![](data:image/svg+xml...)](#rate-limits)
...
## Analytics[![](data:image/svg+xml...)](#analytics)
...
## Progressive Web App (PWA)[![](data:image/svg+xml...)](#progressive-web-app-pwa)
